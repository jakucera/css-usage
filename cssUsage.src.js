...
void function() {
    ...
    function scoreManifest(manifest) {
        ...
        var properties = [
            { name: "theme_color", value: 0x1 },
            { name: "background_color", value: 0x2 },
            { name: "display", value: 0x4 },
            { name: "scope", value: 0x8 },
            { name: "icons", value: 0x10 },
            { name: "short_name", value: 0x20 },
            { name: "name", value: 0x40 },
            { name: "start_url", value: 0x80 }
        ];
